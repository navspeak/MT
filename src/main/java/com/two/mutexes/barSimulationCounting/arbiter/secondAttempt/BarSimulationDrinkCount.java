...
public class BarSimulationDrinkCount
{
	...
	private static final BarSimulationArbiter arbiter = new BarSimulationArbiter();
	...
	private static void displayStatistics()
	{
		for (int i = 1; i <= numberOfThreads; i++)
		{
			...
			int roundsBought = arbiter.getNumBought(name); // These two must
			int roundsSoFar = arbiter.getNumRoundsSoFar(); // happen atomically
